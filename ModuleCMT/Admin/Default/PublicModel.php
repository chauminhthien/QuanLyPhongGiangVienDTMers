...
class PublicModel extends Model{
    ...
    function getMyAccount(){
        ...
        if ($id !== NULL) $result = $this->getOne(TB::ACCOUNTS, TB::F_ACCOUNTS, ['id' => $id]);
        return $result;
    }
	...
	function getPermissionsMyAccount($permis, $root){
		$condition = "";
		if(!$root) $condition = " `id` IN ({$permis})";
		return $this->getMany(TB::PERMISSIONS, TB::F_PERMISSIONS, $condition);
    }
}